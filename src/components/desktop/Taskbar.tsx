  ...
  return (
    <div className="bevel-raised bg-taskbar flex items-center justify-between px-1 py-0.5 select-none">
      <div className="flex items-center gap-1 flex-1 min-w-0">
        <button className="bevel-raised bg-secondary px-3 py-0.5 text-xs font-bold hover:bg-muted active:bevel-sunken shrink-0">
          ▣ Start
        </button>
          ...
          {openWindows.map((win) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 px-2 py-0.5 text-[10px] min-w-[80px] max-w-[140px] truncate ${
                  isActive
      ...
      <div className="bevel-sunken flex items-center gap-2 px-2 py-0.5 shrink-0">
        <span className={`inline-block w-2 h-2 rounded-full ${blinkOn ? "bg-terminal-text" : "bg-muted"}`} />
